...
import { ArrowDownIcon, ArrowUpIcon, CreditCard, DollarSign, Wallet, Receipt, Coins, Landmark, Activity, Users } from "lucide-react"

const icons = {
  "today total collection": CreditCard,
  "today cash": DollarSign,
  "today upi": Wallet,
  "today expenses": Receipt,
  "today bank deposit": Landmark,
  "current cash in hand": Coins,
  "month profit/loss": Activity,
  "partner payable": Users,
}
